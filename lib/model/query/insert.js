...
class Insert {
   constructor(model) {
      ...
      const { name, schemaName, client, aliasIndex, fields } = model;
      ...
      for (const name in fields) {
         ...
         if (ignore.includes(value)) {
            ...
            // 禁止空值
               ...
               throw new TypeError(`${options.sqlKey}字段值不允许为空`);
            ...
            if (typeof value === 'function') {
               ...
               const result = options.sqlValue(value);
