    ...
    for (const field in options) {
      ...
      if (typeof express === 'object') {
        ...
        if (type) {
          ...
          fieldOptions.toSql = typeCtx(field, express);
        ...
        // express为数组结构
          ...
          fields[field] = {
            ...
            toSql: Types.array(field, express),
            default: "'[]'::jsonb",
          };
        ...
        // express为对象结构
          ...
          fields[field] = {
            ...
            toSql: Types.object(field, express),
            default: "'{}'::jsonb",
          };
